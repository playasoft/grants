...
class SigningController {
    ...
    public function __construct()
    {
        $this->Auth_token = "X-Auth-Token:" . "JQhcNFzhao6Pq7YKkJjcom";
...
$application = new Application("Final PHP Test", "Description of the art", 500, 'accepted');
...
$status = $testSign->SigningStatus($ResponseData);
echo $status;
