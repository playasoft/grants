...
@section('content')
    ...
    {!! Form::open() !!}
        ...
        @include('partials/form/textarea', ['name' => 'address', 'label' => 'Address', 'placeholder' => 'Your mailing address', 'value' => (is_null($user->data)) ? '' : $user->data->address])
        @include('partials/form/text', ['name' => 'phone', 'label' => 'Phone Number', 'placeholder' => 'Your 10 digit phone number', 'value' => (is_null($user->data)) ? '' : $user->data->phone])
